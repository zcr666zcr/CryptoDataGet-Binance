...
data_path = {
    ...
    'result_path_perpetual_hour': Path(rf'E:\Quant\data\Perppetual')
}
...
FUNDING_RATE_CONFIG = {
    ...
    'output_dir': CONFIG_PATHS['output'],
}

DAPI_BASE_URL = 'https://dapi.binance.com'
DEFAULT_COINM_SYMBOL = 'BTCUSD_PERP'
COINM_FUNDING_RATE_CONFIG = {
    'base_url': DAPI_BASE_URL,
    'default_symbol': DEFAULT_COINM_SYMBOL,
    'default_limit': 1000,
    'default_save_format': 'csv',
    'output_dir': CONFIG_PATHS['output'],
}
